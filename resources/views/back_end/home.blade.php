                             ...
                             <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-success text-white">
                                    <div class="card-body">
                                        ...
                                        <h4 class="font-500"  style="color:#fff;">{{ $total_orders }}</h4>  
                                        </div></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mini-stat bg-danger text-white">
                                    <div class="card-body">
                                       <a href="admin-orders"> 
                                        ...
                                        <h4 class="font-500"  style="color:#fff;">{{ $pending_orders }}</h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-secondary text-white">
                                    <div class="card-body">
                                        ...
                                        <h4 class="font-500"  style="color:#fff;">{{ $testimonial }}</h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-info text-white">
                                    <div class="card-body">
                                        ...
                                        <h4 class="font-500"  style="color:#fff;">{{ $career }}</h4>
