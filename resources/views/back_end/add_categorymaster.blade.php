                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-b-30">
                                <form action="{{url('new_category')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="card">
                         ...
                         <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                   ...
                                   <tr style="text-align:center">  
                                      ...
                                      <td><button type="submit" class="btn btn-warning" onclick="window.location.href='edit_categoryname?CategoryID={{$row->CategoryID}}'">Edit</button></td>
                                       <td><button type="submit" class="btn btn-danger" onclick="window.location.href='delete_categoryname&{{$row->CategoryID}}'">Delete</button></td>
                                       <?php $i++; ?>
                                   </tr>
                                   @endforeach
                                    </tbody>
