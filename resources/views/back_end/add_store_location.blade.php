...
<div class="content-page">
    ...
    <div class="float-right d-none d-md-block">
            ...
            <div class="button-items">
                    <button type="button" class="btn btn-primary waves-effect waves-light" onclick="window.location.href='{{url('store_location')}}'">View Locators</button>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-b-30">
                                <form action="{{url('new_store')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <div class="row">
