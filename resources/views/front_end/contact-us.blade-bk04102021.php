...
Salem. Tamilnadu, India.</p>
			<p><i class="fa fa-phone"></i><strong>Phone No</strong><br><a href="tel:+0427-4055002">+0427-4055002</a></p>
        ...
        <fieldset class="right">
            ...
            <form method="post" action="{{url('contact_enquiry')}}" onsubmit="return validate();" nctype="multipart/form-data">
                    @csrf
