    ...
    <section class="section-content login-and-register clear">    
        ...
        <div id="login">
            ...
            <p>We are happy to see you return! Please log in to continue.</p>
             <form class="form-horizontal m-t-30" action="user_login_process" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Username">
                            ...
                            <a id="aforgetpassword" onclick="showforgetpage();" href="#" class="right">Forgot Password?</a>
                <div class="clear"></div>
                ...
                <figure class="right"><a href="#"><img src="assets/front_end/images/sigin-in-google.png"></a></figure> -->
                        ...
                        <p>Please enter your email for new password.</p>
             <form class="form-horizontal m-t-30" action="user_forgetpassword" method="POST">
                            @csrf
                           
                            <div class="form-group">
                                <label for="username">Email ID</label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Email ID">
                            </div>
                            <div class="form-group row m-t-20">
                                <div class="col-sm-6 text-right">
                                    <input class="left" name="contact-button" type="submit" value="Submit" id="btnforgetpassword"/>
                                </div>
                            </div>
                            <a id="alogin" onclick="showloginpage();" href="#" class="right">Know Username and Password?</a>
                <div class="clear"></div>
                <!-- <figure class="left"><a href="#"><img src="assets/front_end/images/sigin-in-facebook.png"></a></figure>
                <figure class="right"><a href="#"><img src="assets/front_end/images/sigin-in-google.png"></a></figure> -->
                        </form></div>
        ...
        <fieldset class="right">
			...
			<form id="login_form" method="post" action="login_process" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="user" value="user">
				<div class="form-split left">
                    <label>First Name<span>*</span></label>
                    <input name="first_name" type="text" required></div>
				<div class="form-split right">
                    <label>Last Name<span>*</span></label>
                    <input name="last_name" type="text" required></div>
                <div class="clear"></div>
				<div class="form-split left">
				...
				<div class="form-split right">
                    ...
                    <input name="phone" type="text" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="10" minlength="10"  required></div>
                <div class="clear"></div>
				<label>Address</label>
				...
				<select name="state" id="countySel" class="select-option" size="1">
                <option value="" selected="selected">--Select Country--</option>
                </select>
                </div>
                <div class="form-split right">
                     <label>State<span>*</span></label>
                 <select name="countrya" id="stateSel" class="select-option" size="1">
                <option value="" selected="selected">--Select State--</option>
                </select>
                </div>
                <div class="form-split left">
                     <label>City<span>*</span></label>
                <select name="district" id="districtSel" class="select-option" size="1">
				...
				<div class="form-split right">
                    ...
                    <input name="pincode" type="text" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  minlength="6" maxlength="6"  required>
                </div>
                <div class="clear"></div>
            <?php /*    <div class="form-split left">
                ...
                <div class="clear"></div>
<?php /*				<label>Comments</label>
                <textarea name="comments" rows="6" required></textarea> */ ?>
                <div class="clear"></div>
                <input name="comments" type="text" value="NONE" hidden/>
                <input name="gender" type="text" value="NONE" hidden/>
