...
if(!$mail->Send()) {
  ...
  exit;
     ...
     // return view("front_end.testimonials");
      return redirect('login-and-register')->with('success', 'Customer Register Successfully');
}
...
if($count > 0){
  ...
  return redirect('login-and-register')->with('success2', 'Incorrect Username or Password Please try Again');
