...
return redirect('contact')->with('success2', 'Captcha verification failed, Please try again!');
}
...
//echo  $career_proof;
  ...
  return redirect('career')->with('success3', 'Captcha verification failed, Please try again!');
}
