...
<div id="mySidenav" class="sidenav">
	...
	<ul>
        ...
        <li><a href="<?php echo e('services'); ?>">Services</a></li>
        <li><a href="<?php echo e('image_gallery&1'); ?>">Gallery</a></li>
        <!--<li><a href="<?php echo e('gallery'); ?>">Gallery</a></li>-->
		<li><a href="<?php echo e('maintenance_tips'); ?>">Maintenance Tips</a></li>
        <li><a href="<?php echo e('testimonials'); ?>">Testimonials</a></li>
        <li><a href="<?php echo e('career'); ?>">Career</a></li>
    ...
    <span class="close">&times;</span>
    	<fieldset class="clear">
			...
			<!-- <form method="post" action="#" onsubmit="return validate();"> -->
                <form method="post" action="<?php echo e(url('send_enquiry')); ?>" onsubmit="return validate();" nctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<div id="location" class="modal">
    ...
    <span class="close">&times;</span>
    	<h3><i class="fa fa-map-marker"></i>&nbsp;Choose your State & City</h3>
    	<fieldset class="clear">
...
<div id="Add-Testimonials" class="modal clear">
  <div class="testimonials-modal-content">
        ...
        <fieldset class="clear">
            ...
            <!-- <form method="post" action="#" onsubmit="return validate();"> -->
                <form id="form1" name="form1" method="post" action="<?php echo e(url('testimonial_cus')); ?>" onsubmit="return validate();" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<header class="header clear">
    <header class="header-top clear">
        <aside class="header-contact contacts left">
        ...
        <?php 
          if((Session::get('id')) != ''){
            ...
            <aside class="header-name  right">
              <a href="#">Hi <?php echo e($row->first_name); ?></a>
            </aside>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php } else {?>
        <aside class="header-login log right">
        	<a href="<?php echo e('login-and-register'); ?>">Login / Sign Up</a>
        </aside>
        <?php }?>
    ...
    <header class="header-inner clear">
    	<h1 class="left"><a href="<?php echo e('/'); ?>"><img src="assets/front_end/images/logo.png" alt="XPS Battery Store" title="XPS Battery Store"></a></h1>
        <nav class="nav left">
            <ul>
                ...
                <li><a href="<?php echo e('products'); ?>">Buy Online</a></li>
                <li><a href="<?php echo e('store_locator'); ?>">Store Locator</a></li>
        		<li><a href="<?php echo e('franchise'); ?>">Franchise </a></li>
      ...
      <ul class="count">
        <li class="cart_total_count"><?php echo e(count((array) session('cart'))); ?></li>
      </ul>
      </a>
      <div class="cd-cart">
        <div class="wrapper">
        ...
        <?php if(session('cart')): ?>
            <?php $__currentLoopData = (array) session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: center;" data-th="Price">₹<?php echo e($details['price']); ?></td>
                    <td style="text-align: center;" data-th="Quantity"><?php echo e($details['quantity']); ?></td>
                    <td style="text-align: center;" data-th="Subtotal" class="text-center">₹<span class="product-subtotal"><?php echo e(($details['price'] * $details['quantity']) -$details['scrabamount']); ?></span></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
</tbody></table>
          ...
          <?php $total = 0 ?>
                ...
                <?php if(count((array) session('cart'))>= 0): ?>
                 <a href="cart-view" class="checkout btn"><em>Checkout - Rs.<span id="sum_subtotal"> <?php echo e($total); ?></span></em></a> 
               <?php endif; ?>
                </footer>
        </div>
      </div>
...
<script>
    ...
    function redirectpage(){
        window.location = '<?php echo e(url('personal-information')); ?>';
    }
...
</html><?php /**PATH /home/binarycl/xpsbatterystore.com/resources/views/front_end/productheader.blade.php ENDPATH**/ ?>