            ...
            <fieldset class="clear">
                <form method="post" action="update_profile" onsubmit="return validate();">
                    ...
                    <div class="form-split left">
                        ...
                        <input name="firstname" type="text" value="<?php echo e($row->first_name); ?>" placeholder="" required></div>
                    <div class="form-split right">
                        <label>Last Name</label><br/><br/>
                        <input name="lastname" type="text" value="<?php echo e($row->last_name); ?>" placeholder="" required></div>

                    <div class="clear"></div>
                    <div class="form-split left">
                        <label>Email Id</label><br/><br/>
                        <input name="email" type="text" value="<?php echo e($row->email); ?>" placeholder="" required></div>
                    <div class="form-split right">
                        <label>Mobile Number</label><br/><br/>
                        <input name="phone" type="text" value="<?php echo e($row->phone); ?>"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="10" minlength="10"  placeholder="" required></div>
                    <div class="clear"></div>

                    <div class="form-split left">
                        <label>Country</label><br/><br/>
                        <!-- <input name="country" type="text" value="<?php echo e($row->country); ?>" placeholder="" required> -->
                        <select name="country" id="countySel" class="select-option" size="1">
                        <option value="<?php echo e($row->country); ?>" selected="selected" style="background: #006f3b;color:#fff;"><?php echo e($row->country); ?></option>
                        </select>
                    </div>
                    <div class="form-split right">
                        <label>State</label><br/><br/>
                       <!--  <input name="state" type="text" value="<?php echo e($row->state); ?>" placeholder="" required> -->
                           <select name="state" id="stateSel" class="select-option" size="1">
                            <option value="<?php echo e($row->state); ?>" selected="selected" style="background: #006f3b;color:#fff;"><?php echo e($row->state); ?></option>
                            </select>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="form-split left">
                        ...
                        <option value="<?php echo e($row->city); ?>" selected="selected" style="background: #006f3b;color:#fff;"><?php echo e($row->city); ?></option>
                        </select>
                        <!-- <input name="city" type="text" value="<?php echo e($row->city); ?>" placeholder="" required> -->
                    </div>
                    <div class="form-split right">
                        <label>Pincode</label><br/><br/>
                        <input name="pincode" type="text" value="<?php echo e($row->pincode); ?>" placeholder="" required></div>
                    <div class="clear"></div>

                    <div class="form-split left ">
                        <label>Address</label><br/><br/>
                        <textarea name="address" rows="3" required><?php echo e($row->address); ?></textarea>
                        <!-- <input name="pincode" type="text" value="<?php echo e($row->address); ?>" placeholder="" required> -->
                    </div>
                     <div class="form-split right ">
                    <!-- <h3>Gender</h3> --><br/>
                    <div class="clear"></div>
                    ...
                    <div class="left">
                        <input name="gender" class="radio-custom" <?php echo e(($row->gender == 'Male' ? ' checked' : '')); ?> id="Male" type="radio" value="Male">
                        <label class="radio-custom-label" for="Male" >Male</label>
                    </div>

                    <div class="left" style="margin-left:15px;">
                        <input name="gender" class="radio-custom" <?php echo e(($row->gender == 'Female' ? ' checked' : '')); ?> id="Female" type="radio" value="Female">
...
<?php echo $__env->make('front_end.header2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binarycl/xpsbatterystore.com/resources/views/front_end/edit-personal-details.blade.php ENDPATH**/ ?>