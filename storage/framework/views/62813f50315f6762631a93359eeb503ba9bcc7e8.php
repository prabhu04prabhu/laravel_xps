...
<header class="banner clear">
    <div class="container">
        ...
        <?php
                ...
                ?>
                <?php $__currentLoopData = $slide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sliderow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                <div class="img--holder slide--has-caption" style="background-image: url(image/<?php echo e($sliderow->image); ?>)">
...
<section class="section">
    ...
    <section class="battery-finder clear" style="display:none;">
        ...
        <fieldset class="right">
               ...
               <?php
                ...
                <option value="<?php echo e($row_shop->CategoryID); ?>"> <?php echo e($row_shop->CategoryName); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <select id="capacity" name="capacity"  class="dropdownsytyle" style="display:none;">
                    ...
                    <?php
                        ...
                        ?>
                        <?php $__currentLoopData = $cap_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_cap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <option value="<?php echo e($row_cap->CapacityID); ?>"> <?php echo e($row_cap->CapacityName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
               ...
               <!--  <select id="appliance" name="appliance"  class="dropdownsytyle" style="display:none;">
                    ...
                    <?php
                        ...
                        ?>
                        <?php $__currentLoopData = $app_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <option value="<?php echo e($row_app->app_id); ?>"> <?php echo e($row_app->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select> -->
                ...
                <div class="item">
                    ...
                    <figcaption>
                        <div class="shop-icons">
                            <a href="javascript:void(0);" data-id="<?php echo e($row_product->ProductID); ?>" class="add-to-cart" data-price="<?php echo e($row_product->MRP); ?>" data-rate="<?php echo e($row_product->OnlinePricing); ?>" title="Cart"><i class="fa fa-shopping-cart"></i></a>
    ...
    <section class="section-testimonial clear">
        ...
        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item">
                <figure class="left"> <img src="<?php echo url('/'); ?>/image/<?php echo e($row->image); ?>" class="testimonial_img"></figure>
                <aside class="right">
...
<div id="myModals" class="modal fade" role="dialog">
  <div class="modal-dialog">
   ...
   function loadproducts() {
    ...
    //        window.location = '<?php echo e(url('products')); ?>';    
    // $.post('<?php echo e(url('products')); ?>', {"scategoryid": $("#idcategory").val(), 
    ...
    // $.ajax({
    //         url: '<?php echo e(url('sessionfilter')); ?>',
    //         method: "POST",
...
<?php echo $__env->make('front_end.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binarycl/xpsbatterystore.com/resources/views/front_end/index.blade.php ENDPATH**/ ?>