...
<header class="header clear">
    <header class="header-top clear">
        ...
        <aside class="header-social-media medias left">
    ...
    <header class="header-inner clear">
      ...
      <ul class="count">
        <li><?php echo e(count((array) session('cart'))); ?></li>
      </ul>
      </a>
      <div class="cd-cart">
        <div class="wrapper">
        ...
        <?php endif; ?>
          ...
          <?php $total = 0 ?>
                ...
                <?php if(count((array) session('cart'))> 0): ?>
                 <a href="cart-view" class="checkout btn"><em>Checkout - Rs.<span> <?php echo e($total); ?></span></em></a> 
               <?php endif; ?>
                </footer>
        </div>
      </div>
...
</html><?php /**PATH /home/binarycl/xpsbatterystore.com/resources/views/front_end/header2.blade.php ENDPATH**/ ?>