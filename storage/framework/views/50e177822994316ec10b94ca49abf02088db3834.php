...
<header class="banner-heading clear">
	...
	<div class="banner-nav right">
     ...
     $view_id = request('ProductID');
        $shop = DB::table('productmaster')
                ...
                ?>
                     <?php $__currentLoopData = $shop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
    <section class="section-content shop clear">  
		<aside class="product-image left">
            <img src="<?php echo e($row_shop->image); ?>" title="Product Image" alt="Product Image">
        </aside>
    	<aside class="product-details right">
        	<div class="product-details-col-left left">
                <h2 style="width:auto;"><?php echo e($row_shop->BrandName); ?> <?php echo e($row_shop->ProductModelNo); ?> <?php echo e($row_shop->ProductCode); ?></h2>
                <h3>QUICK OVERVIEW</h3>
                <p><strong>Product Brand</strong> : <?php echo e($row_shop->BrandName); ?><br>
                <strong>Model Number</strong> : <?php echo e($row_shop->ProductModelNo); ?><br>
                <strong>Product Name</strong> : <?php echo e($row_shop->SubBrandName); ?><br>
                <strong>Product Capacity</strong> : <?php echo e($row_shop->CapacityName); ?><br>
                <strong>Product Warranty</strong> : <?php echo e($row_shop->Warranty); ?></p>
                <h4>Availability : 
                    <?php if($row_shop->availability == 'Yes'){?>
                        <span>In Stock</span> <?php }else{ ?>
                        <span>Out of Stock</span><?php } ?></h4>
                <figcaption>Price: <del>Rs. <?php echo e($row_shop->MRP); ?></del> <span><?php echo e($row_shop->discount_percent); ?>% OFF</span> </figcaption>
                <!-- <div class="battery-price clear">
                    ...
                    <label class="checkbox-custom-label" for="With Old Battery" >With Old Battery: <strong>Rs. <?php echo e($withold); ?></strong></label>
                </div>
                ...
                <?php $total = 0 ?>
				    ...
				    <label class="checkbox-custom-label" for="Without Old Battery" >Without Old Battery: <strong>Rs. <?php echo e($total); ?></strong></label>
                </div> -->
                <div class="battery-price clear">
                <?php $withold = 0 ?>
                    <?php $withold = $row_shop->OnlinePricing - $row_shop->scrab_amount;  ?>
                    <input name="With_Old_Battery" class="checkbox-custom" id="With_Old_Battery" type="checkbox" value="With Old Battery" >
                    <label class="checkbox-custom-label" for="With_Old_Battery" >With Old Battery: <strong>Rs. <?php echo e($withold); ?></strong> (Rs.<?php echo e($row_shop->scrab_amount); ?> off)</label>
                </div>
                <?php $total = 0 ?>
                    <?php $total = $row_shop->OnlinePricing ?>
                <input name="name" style='display:none;' type="text" placeholder=""  id="txtprice" value="<?php echo e($total); ?>"/>
                <input name="name" style='display:none;' type="text" placeholder=""  id="txtoriginalprice" value="<?php echo e($row_shop->MRP); ?>"/>
                <input name="name" style='display:none;' type="text" placeholder=""  id="txtonlineprice" value="<?php echo e($row_shop->OnlinePricing); ?>"/>
                <input name="name" style='display:none;' type="text" placeholder=""  id="txtDiscount" value="<?php echo e($row_shop->discount_percent); ?>"/>
                <input name="name" style='display:none;' type="text" placeholder=""  id="txtscrap" value="<?php echo e($row_shop->scrab_amount); ?>"/>
        	...
        	<div class="product-details-col-right right">
                ...
                <?php $total = 0 ?>
                    <?php $total = $row_shop->OnlinePricing?>
                <h1 id="iRate">₹ <?php echo e($total); ?></h1><h1><small>(Prices are inclusive of all taxes)</small></h1>
                <form>
                	<h5>Quantity</h5>
				...
				<a href="javascript:void(0);" data-id="<?php echo e($row_shop->ProductID); ?>" class="btn btn-warning btn-block text-center add-to-cart" role="button"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;Add to cart</a>
    ...
    <section class="product-description clear">
        ...
        <div id="Specifications" class="tabcontent">
            ...
            echo html_entity_decode($row_shop->specification);
                ?>
            <!-- <?php echo e($row_shop->specification); ?> -->
    ...
    <?php
                ...
                ?>
                     <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="item">
      <a href="shop&id=<?php echo e($row_product->ProductID); ?>"  class="button quick-shop">Quick Shop</a>
				<figure>
				<figcaption>
					<div class="shop-icons">
          <a href="javascript:void(0);" data-id="<?php echo e($row_product->ProductID); ?>" class="add-to-cart1" data-price="<?php echo e($row_product->MRP); ?>" data-rate="<?php echo e($row_product->OnlinePricing); ?>" title="Cart"><i class="fa fa-shopping-cart"></i></a>
          <a href="#" title="Wishlist"><i class="fa fa-heart"></i></a>
          <a href="shop&id=<?php echo e($row_product->ProductID); ?>" title="View Product"><i class="fa fa-eye"></i></a>
					</div>
          <h3><?php echo e($row_product->BrandName); ?></h3>
          <h2><del style="color: black;font-size: 18px;">Rs.<?php echo e($row_product->MRP); ?></del> Rs.<?php echo e($row_product->OnlinePricing); ?>/-</h2>
				</figcaption>
				<img src="<?php echo e($row_product->image); ?>">
				</figure>
			</div>	
...
$(".add-to-cart").click(function (e) {
    ...
    $(".add-to-cart1").click(function (e) {
        ...
        var ele = $(this);
        ele.siblings('.btn-loading').show();
        var price=ele.attr("data-price") - (ele.attr("data-price") * <?php echo e(env('DEFAULT_DISCOUNT')); ?>/100);
        $.ajax({
            url: '<?php echo e(url('add-to-cart')); ?>',
            method: "POST",
            data: {quantity: 1,
...
<?php echo $__env->make('front_end.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binarycl/xpsbatterystore.com/resources/views/front_end/shop.blade.php ENDPATH**/ ?>